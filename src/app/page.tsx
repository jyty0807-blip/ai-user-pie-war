    ...
    <div className="flex min-h-screen flex-col bg-[#fdfcfc] dark:bg-[#1a1a1a]">
      ...
      <header className="border-b border-[rgba(15,0,0,0.12)] dark:border-[rgba(255,255,255,0.08)]">
        <div className="mx-auto flex max-w-4xl items-center justify-between px-4 py-3 sm:px-6">
          ...
          <Link
            href="/dashboard"
            className="rounded-sm border border-[rgba(15,0,0,0.12)] bg-[#201d1d] px-3 py-1.5 text-xs font-medium text-[#fdfcfc] transition-colors hover:bg-[#0f0000] dark:border-[rgba(255,255,255,0.2)] dark:bg-[#fdfcfc] dark:text-[#201d1d] dark:hover:bg-[#e8e8e8]"
          >
            대시보드 입장
          </Link>
        </div>
        ...
        <section className="border-b border-[rgba(15,0,0,0.08)] dark:border-[rgba(255,255,255,0.06)]">
          <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 sm:py-24">
            ...
            <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-3">
              {[
                { step: "1", emoji: "📝", title: "설문", desc: "6가지 질문에 답하면 당신의 상황을 파악합니다" },
                { step: "2", emoji: "🧠", title: "추천", desc: "벤치마크 기반 엔진이 최적의 조합을 찾습니다" },
                { step: "3", emoji: "🚀", title: "적용", desc: "원화 결제 예상가와 수수료 절약 팁까지 제공" },
              ].map((item) => (
              ...
              {sections.map((section) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    <span className="mt-0.5 text-xl">{section.emoji}</span>
